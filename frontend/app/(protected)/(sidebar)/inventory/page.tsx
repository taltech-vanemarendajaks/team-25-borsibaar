...
export default function Inventory() {
  ...
  return (
    <div className="bg-background min-h-screen p-4">
      <div className="bg-card border-[color-mix(in oklab, var(--ring) 50%, transparent)] rounded-lg border-1 p-6 shadow-sm">
        <div className="mb-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Button
              ...
              className="flex items-center gap-2 rounded-lg bg-blue-100 px-4 py-2 font-medium text-black transition hover:bg-blue-200"
            >
        ...
        {error && (
          <div className="mb-4 flex items-center gap-2 rounded-lg border border-red-800 bg-red-950 p-4 text-red-50">
        ...
        <div className="relative mb-6">
          ...
          <Input
            ...
            className="w-full rounded-lg border border-gray-600 py-2 pr-4 pl-10 focus:border-transparent focus:ring-2 focus:ring-blue-500"
          />
        </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-400">
                ...
                <th className="px-4 py-3 text-left font-semibold text-gray-300">Current Price</th>
                <th className="px-4 py-3 text-left font-semibold text-gray-300">Min Price</th>
                <th className="px-4 py-3 text-left font-semibold text-gray-300">Max Price</th>
                <th className="px-4 py-3 text-center font-semibold text-gray-300">Quantity</th>
                <th className="px-4 py-3 text-center font-semibold text-gray-300">Status</th>
                <th className="px-4 py-3 text-left font-semibold text-gray-300">Last Updated</th>
                ...
                filteredInventory.map(item => {
                  ...
                  return (
                    <tr key={item.id} className="border-b border-gray-400 hover:bg-gray-800">
                      ...
                      <td className="text-gray400 px-4 py-3 text-sm">
                      ...
                      <td className="px-4 py-3">
                        <div className="flex flex-wrap justify-center gap-2">
                          <Button
                            ...
                            className="rounded-lg bg-green-700 p-2 text-green-100 transition hover:bg-green-800"
                            title="Add Stock"
                          >
                            <Plus className="h-4 w-4" />
                          </Button>
                          <Button
                            ...
                            className="rounded-lg bg-red-700 p-2 text-red-100 transition hover:bg-red-800"
                            title="Remove Stock"
                          >
                          ...
                          <Button
                            ...
                            className="rounded-lg bg-blue-700 p-2 text-blue-100 transition hover:bg-blue-800"
                            title="Adjust Stock"
                          >
                          ...
                          <Button
                            ...
                            className="rounded-lg bg-gray-700 p-2 text-gray-400 transition hover:bg-gray-800"
                            title="View History"
                          >
      ...
      <Dialog open={showCreateProductModal} onOpenChange={setShowCreateProductModal}>
        <DialogContent className="sm:max-w-[500px]">
          ...
          <div className="mt-4 space-y-4">
            <div>
              <label className="mb-1 block text-sm font-medium text-gray-300">Product Name *</label>
              <Input
                type="text"
            ...
            <div>
              <label className="mb-1 block text-sm font-medium text-gray-300">Min price *</label>
              <Input
                type="number"
                step="0.01"
                min="0"
            ...
            <div>
              <label className="mb-1 block text-sm font-medium text-gray-300">Max price *</label>
              <Input
                type="number"
                step="0.01"
                min="0"
            ...
            <div>
              ...
              <Input
                ...
                placeholder="0"
              />
              <p className="mt-1 text-xs text-gray-500">Leave empty or 0 for no initial stock</p>
            </div>
            <div>
        ...
        <DialogContent className="max-h-[80vh] overflow-y-auto sm:max-w-2xl">
          ...
          >
            {loadingHistory ? (
              ...
              <p className="py-8 text-center text-gray-500">No transaction history found</p>
            ) : (
              <div className="space-y-3">
                {transactionHistory.map(transaction => (
                  ...
                  >
                    ...
                    {transaction.notes && (
                      <p className="mt-2 text-sm text-gray-300">{transaction.notes}</p>
                    )}
                    {transaction.referenceId && (
                      <p className="mt-1 text-xs text-gray-500">Ref: {transaction.referenceId}</p>
                    )}
